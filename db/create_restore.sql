...
RESTORE DATABASE [ActivitySignUpDatabase] FROM DSIK='/tmp/ActivitySignUpDatabase.bak' 
WITH 
REPLACE, 
MOVE 'ActivitySignUpDatabase.mdf' TO '/var/opt/mssql/data/ActivitySignUpDatabase.mdf',
MOVE 'ActivitySignUpDatabase_Log.ldf' TO '/var/opt/mssql/data/ActivitySignUpDatabase_Log.ldf';
go
